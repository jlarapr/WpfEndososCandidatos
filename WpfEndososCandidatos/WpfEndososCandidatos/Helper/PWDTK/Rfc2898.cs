namespace WpfEndososCandidatos.Helper.PWDTK
{
    using System;
    using System.Linq;
    using System.Text;
    ...
    public class Rfc2898
    {
        ...
        /// <param name="salt">Salt to be concatenated with the password</param>
        /// <param name="iterations">Number of iterations to perform HMACSHA Hashing for PBKDF2</param>
        public Rfc2898(String password, Byte[] salt, Int32 iterations)
        ...
        /// <param name="salt">Salt to be concatenated with the password</param>
        /// <param name="iterations">Number of iterations to perform HMACSHA Hashing for PBKDF2</param>
        public Rfc2898(String password, String salt, Int32 iterations)
