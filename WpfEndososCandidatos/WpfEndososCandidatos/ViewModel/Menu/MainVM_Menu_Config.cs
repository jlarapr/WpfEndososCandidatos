...
namespace WpfEndososCandidatos.ViewModel
{
    ...
    partial class MainVM
    {
        ...
        private void BaseDeDatos_Click()
        {
            ...
            {
                MessageBox.Show(ex.ToString(), "BaseDeDatos_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void Areas_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "areas_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void Partidos_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Partidos_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void Notarios_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Notarios_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        ...
        private void Validaciones_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Validaciones_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void Usuarios_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Usuarios_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void InicializarLotes_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "InicializarLotes_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void About_Click()
        {
            ...
            {
                MessageBox.Show(ex.Message, "About_Click", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
